    ...
    _createClass(UserForm, [{
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'button',
            { type: 'submit', className: _UserFormScss2['default'].button },
            'Search'
          )
        );
      }
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".UserForm_label_1hU {\n  display: inline-block;\n  font-weight: 700;\n  font-size: 18px;\n  margin-bottom: 5px;\n}\n\ninput[type=\"text\"].UserForm_textField_3Jo {\n  width: 20em;\n  display: inline-block;\n  margin: 0 10px;\n}\n\ninput[type=\"text\"].UserForm_textField_3Jo, .UserForm_button_kBN {\n  font-size: 18px;\n}\n\n.UserForm_title_3Xu {\n  margin: 0 0 10px;\n}\n\n.UserForm_form_3Ui {\n  margin: 0 auto;\n  text-align: center;\n}\n", "", {"version":3,"sources":["/./src/components/UserForm/UserForm.scss"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;CACpB;;AAED;EACE,YAAY;EACZ,sBAAsB;EACtB,eAAe;CAChB;;AAED;EAEE,gBAAgB;CACjB;;AAED;EACE,iBAAiB;CAClB;;AAED;EACE,eAAe;EACf,mBAAmB;CACpB","file":"UserForm.scss","sourcesContent":[".label {\n  display: inline-block;\n  font-weight: 700;\n  font-size: 18px;\n  margin-bottom: 5px;\n}\n\ninput[type=\"text\"].textField {\n  width: 20em;\n  display: inline-block;\n  margin: 0 10px;\n}\n\ninput[type=\"text\"].textField,\n.button {\n  font-size: 18px;\n}\n\n.title {\n  margin: 0 0 10px;\n}\n\n.form {\n  margin: 0 auto;\n  text-align: center;\n}\n"],"sourceRoot":"webpack://"}]);
