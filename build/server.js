...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".Footer_footer_2nh{display:block;margin-top:40px;color:#8b8086;font-size:12px;background-color:#0d0c0b}.Footer_innerContainer_3fW{max-width:1000px;margin:0 auto;padding:40px 0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".Header_header_3bM{padding-top:40px;margin-bottom:40px}.Header_title_YtT{margin:0 auto;max-width:1000px}.Header_brand_1-T{text-decoration:none}.Header_separator_1Qr:after,.Header_separator_1Qr:before{content:\"\\A0\"}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Palette = (function (_Component) {
    ...
    _createClass(Palette, [{
      key: 'getHexColors',
      value: function getHexColors() {
        var baseColors = [this.props.bg, this.props.primary, this.props.secondary, this.props.detail];
        var hexColors = [];
        for (var i = 0; i < baseColors.length; i++) {
          hexColors.push(baseColors[i]);
          var color = (0, _tinycolor22['default'])(baseColors[i]);
      ...
      key: 'render',
      value: function render() {
        var hexColors = this.getHexColors();
        return _react2['default'].createElement(
          'div',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".Palette_container_1Ha{margin-bottom:20px}.Palette_colors_jGR{list-style:none;padding-left:0}.Palette_colors_jGR li{display:inline}.Palette_title_2zJ{margin:0 0 5px;font-weight:700;text-align:center;letter-spacing:.05em}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".Swatch_container_2L5{display:inline-block;padding:2px 4px;border-radius:2px;width:5em;text-align:center;font-size:15px;margin:2px}.Swatch_name_3UP{font-family:Ocr A Extended,Courier New,monospace}", ""]);
