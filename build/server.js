  ...
  var router = new _reactRoutingSrcRouter2['default'](function (on) {
    ...
    on('/', function callee$1$0() {
      return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.abrupt('return', _react2['default'].createElement(_componentsUserForm2['default'], null));
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var UserForm = (function (_Component) {
    ...
    function UserForm(props, context) {
      ...
      _get(Object.getPrototypeOf(_UserForm.prototype), 'constructor', this).call(this, props, context);
    ...
    _createClass(UserForm, [{
      ...
      value: function render() {
        ...
        var messageClass = this.state.error ? _UserFormScss2['default'].error : _UserFormScss2['default'].success;
        return _react2['default'].createElement(
          'div',
          { className: _UserFormScss2['default'].container },
          _react2['default'].createElement(
            'form',
            { className: _UserFormScss2['default'].form, onSubmit: this.handleSubmit.bind(this) },
            _react2['default'].createElement(
              'h1',
              { className: _UserFormScss2['default'].title },
              title
            ),
            _react2['default'].createElement(
              'label',
              { className: _UserFormScss2['default'].label,
                htmlFor: 'user-name'
              },
              'Steam user name:'
            ),
            _react2['default'].createElement('input', { type: 'text', autoFocus: 'autofocus', className: _UserFormScss2['default'].textField,
              id: 'user-name',
            ...
            _react2['default'].createElement(
              ...
              { type: 'submit', disabled: this.state.disabled,
                className: _UserFormScss2['default'].button
              },
              'Search'
            ),
            _react2['default'].createElement(
              'p',
              { className: (0, _classnames2['default'])(_UserFormScss2['default'].message, messageClass), style: messageStyle },
              this.state.message
            )
          ),
          typeof this.state.steamID === 'undefined' ? '' : _react2['default'].createElement(_PlayerSummaryPlayerSummary2['default'], { key: this.state.steamID,
    ...
    UserForm = (0, _decoratorsWithStyles2['default'])(_UserFormScss2['default'])(UserForm) || UserForm;
    return UserForm;
  })(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
      ...
      // https://webpack.github.io/docs/hot-module-replacement
      if (false) {
        module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!./../../../node_modules/postcss-loader/index.js!./UserForm.scss", function() {
          var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!./../../../node_modules/postcss-loader/index.js!./UserForm.scss");
          if (typeof newContent === 'string') {
            newContent = [[module.id, content, '']];
          }
          removeCss = insertCss(newContent, { replace: true });
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "/* Extra small screen / phone */  /* Small screen / tablet */  /* Medium screen / desktop */ /* Large screen / wide desktop */\n\n.UserForm_label_1hU {\n  display: inline-block;\n  font-weight: 700;\n  font-size: 18px;\n  margin-bottom: 5px;\n}\n\ninput[type=\"text\"].UserForm_textField_3Jo {\n  width: 20em;\n  display: inline-block;\n  margin: 0 10px;\n}\n\ninput[type=\"text\"].UserForm_textField_3Jo, .UserForm_button_kBN {\n  font-size: 18px;\n}\n\n.UserForm_title_3Xu {\n  margin: 0 0 10px;\n}\n\n.UserForm_form_3Ui {\n  margin: 0 auto;\n  text-align: center;\n}\n\n.UserForm_message_1cA {\n}\n\n.UserForm_message_1cA.UserForm_success_27Z {\n  color: #A5A781;\n}\n\n.UserForm_message_1cA.UserForm_error_tvB {\n  color: #A78E81;\n}\n\n.UserForm_container_2oM {\n\n}\n", "", {"version":3,"sources":["/./src/components/variables.scss","/./src/components/UserForm/UserForm.scss"],"names":[],"mappings":"AAEgC,gCAAgC,EAChC,2BAA2B,EAC3B,6BAA6B,CAC7B,iCAAiC;;ACHjE;EACE,sBAAsB;EACtB,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;CACpB;;AAED;EACE,YAAY;EACZ,sBAAsB;EACtB,eAAe;CAChB;;AAED;EAEE,gBAAgB;CACjB;;AAED;EACE,iBAAiB;CAClB;;AAED;EACE,eAAe;EACf,mBAAmB;CACpB;;AAED;CAQC;;AAPC;EACE,eAA2B;CAC5B;;AAED;EACE,eAAyB;CAC1B;;AAGH;;CAEC","file":"UserForm.scss","sourcesContent":["$font-family-base:      'Arimo', 'Segoe UI', 'HelveticaNeue-Light', sans-serif;\r\n$max-content-width:     1000px;\r\n$screen-xs-min:         480px;  /* Extra small screen / phone */\r\n$screen-sm-min:         768px;  /* Small screen / tablet */\r\n$screen-md-min:         992px;  /* Medium screen / desktop */\r\n$screen-lg-min:         1200px; /* Large screen / wide desktop */\r\n$animation-swift-out:   .45s cubic-bezier(0.3, 1, 0.4, 1) 0s;\r\n\r\n$body-bg: #222314;\r\n$text-color: #F5EFEF;\r\n$link-color: #fff;\r\n$hover-link-color: #8B8086;\r\n$header-color: #8B8086;\r\n$input-bg: #8B8086;\r\n$input-text-color: #fff;\r\n$border-color: #574E4F;\r\n$border-radius: 2px;\r\n$input-border-color: $border-color;\r\n$input-border-radius: $border-radius;\r\n$success-text-color: #A5A781;\r\n$error-text-color: #A78E81;\r\n","@import '../variables.scss';\n\n.label {\n  display: inline-block;\n  font-weight: 700;\n  font-size: 18px;\n  margin-bottom: 5px;\n}\n\ninput[type=\"text\"].textField {\n  width: 20em;\n  display: inline-block;\n  margin: 0 10px;\n}\n\ninput[type=\"text\"].textField,\n.button {\n  font-size: 18px;\n}\n\n.title {\n  margin: 0 0 10px;\n}\n\n.form {\n  margin: 0 auto;\n  text-align: center;\n}\n\n.message {\n  &.success {\n    color: $success-text-color;\n  }\n\n  &.error {\n    color: $error-text-color;\n  }\n}\n\n.container {\n\n}\n"],"sourceRoot":"webpack://"}]);
  
  // exports
  exports.locals = {
  	"label": "UserForm_label_1hU",
  	"textField": "UserForm_textField_3Jo",
  	"button": "UserForm_button_kBN",
  	"title": "UserForm_title_3Xu",
  	"form": "UserForm_form_3Ui",
  	"message": "UserForm_message_1cA",
  	"success": "UserForm_success_27Z",
  	"error": "UserForm_error_tvB",
  	"container": "UserForm_container_2oM"
  };
